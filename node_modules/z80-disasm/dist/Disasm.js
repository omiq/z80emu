...
export class Disasm {
    constructor() {
        ...
        this.readMemory = (address) => this.memory[address];
         ...
         */
        this.opcodeToAdditionDataLength = new Map();
    }
    /**
     ...
     */
    addAdditionalDataLength(opcode, length) {
     ...
     */
    disassembleOne(address, readMemory) {
        var _a;
     ...
     */
    makeDataInstruction(startAddress) {
        ...
        let startOfText = undefined;
        let startOfTextChunk = undefined;
     ...
     */
    disassembleTrace(address, readMemory) {
    ...
    disassemble() {
        ...
        const addAddressToDecode = (address) => {
    ...
    replaceTargetAddress(instruction) {
        if (instruction.jumpTarget !== undefined) {
     ...
     */
    getAdditionalDataLength(instruction) {
        var _a;
        return _a = this.opcodeToAdditionDataLength.get(instruction.bin[0]), (_a !== null && _a !== void 0 ? _a : 0);
    }
}
